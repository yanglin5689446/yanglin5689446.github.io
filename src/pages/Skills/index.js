...
const skillSet = {
  Language: [
    ...
    { title: 'Python', thumbnail: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/2000px-Python-logo-notext.svg.png' },
  ...
  Backend: [
    { title: 'Laravel', thumbnail: 'http://logonoid.com/images/laravel-logo.png' },
    ...
    { title: 'Lumen', degree: 'average', thumbnail: 'https://cdn.worldvectorlogo.com/logos/lumen-1.svg' },
  ],
  Database: [
  ...
  Frontend: [
    ...
    { title: 'P5', degree: 'fair', thumbnail: 'http://blindedcyclops.neocities.org/p5js-icons/p5-sq-white-background.png' },
